...
FEATURE_CSV = ROOT / "research" / "lab_gait_10s" / "01_preprocessing" / "labwalks_service10_amp_spec_features.csv"
DAILY_WINDOW_CSV = ROOT / "research" / "lab_gait_10s" / "05_daily75h_validation" / "daily75h_service10_model_windows_merged.csv"
DAILY_SUBJECT_CSV = ROOT / "research" / "lab_gait_10s" / "05_daily75h_validation" / "daily75h_fixed_model_subject_predictions.csv"
CLINICAL_XLSX = ROOT / "research" / "lab_gait_10s" / "04_clinical_data" / "ClinicalDemogData_COFL.xlsx"
OUT_DIR = ROOT / "research" / "lab_gait_10s" / "12_three_feature_candidate_validation"
