...
MODEL_PATH = ROOT / "research" / "lab_gait_10s" / "02_model" / "final_motor_domain4_labwalks10_logistic_C0p5_nested_youden.joblib"
WINDOW_CSV = ROOT / "research" / "lab_gait_10s" / "05_daily75h_validation" / "daily75h_service10_model_windows_merged.csv"
SUBJECT_CSV = ROOT / "research" / "lab_gait_10s" / "05_daily75h_validation" / "daily75h_fixed_model_subject_predictions.csv"
OUT_DIR = ROOT / "research" / "lab_gait_10s" / "08_random20_best10_service_simulation"
